...
(function() {
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                ...
                var m = 0,
                    p = 0,
                    p = m = m = 0;
                0 > b ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 > k && l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b < k && (b = -(k - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b))) : l.indexLabelTextBlock.y + l.indexLabelTextBlock.height /
                    2 < k && l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b > h && (b = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b - h);
                b = l.indexLabelTextBlock.y + b;
                k = 0;
                k = "right" === l.hemisphere ? v.x + Math.sqrt(Math.pow(s, 2) - Math.pow(b - v.y, 2)) : v.x - Math.sqrt(Math.pow(s, 2) - Math.pow(b - v.y, 2));
                p = v.x + A * Math.cos(l.midAngle);
                m = v.y + A * Math.sin(l.midAngle);
                m = Math.sqrt(Math.pow(k - p, 2) + Math.pow(b - m, 2));
                p = Math.acos(A / s);
                m = Math.acos((s * s + A * A - m * m) / (2 * A * s));
                b = m < p ? b - l.indexLabelTextBlock.y : 0;
                k = null;
                for (h = 1; h < n.length; h++)
                    if (k =
                        (a - h + q.length) % q.length, q[k].hemisphere !== q[a].hemisphere) {
                        k = null;
                        break
                ...
                m = e(a);
                h = k = 0;
                0 > b ? (h = "right" === l.hemisphere ? p : m, g = b, null !== h && (p = -b, b = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - (q[h].indexLabelTextBlock.y + q[h].indexLabelTextBlock.height /
                    2), b - p < r && (k = -p, h = f(h, k, c + 1), +h.toFixed(u) > +k.toFixed(u) && (g = b > r ? -(b - r) : -(p - (h - k)))))) : 0 < b && (h = "right" === l.hemisphere ? m : p, g = b, null !== h && (p = b, b = q[h].indexLabelTextBlock.y - q[h].indexLabelTextBlock.height / 2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2), b - p < r && (k = p, h = f(h, k, c + 1), +h.toFixed(u) < +k.toFixed(u) && (g = b > r ? b - r : p - (k - h)))));
                g && (c = l.indexLabelTextBlock.y + g, b = 0, b = "right" === l.hemisphere ? v.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - v.y, 2)) : v.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - v.y, 2)), l.midAngle >
                    Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t ? (k = (a - 1 + q.length) % q.length, k = q[k], a = q[(a + 1 + q.length) % q.length], "left" === l.hemisphere && "right" === k.hemisphere && b > k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x - 15 : "right" === l.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t && (k = (a - 1 + q.length) % q.length, k = q[k], a = q[(a + 1 + q.length) % q.length], "right" === l.hemisphere && "left" === k.hemisphere && b < k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x +
                        15 : "left" === l.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x - 15)), l.indexLabelTextBlock.y = c, l.indexLabelTextBlock.x = b, l.indexLabelAngle = Math.atan2(l.indexLabelTextBlock.y - v.y, l.indexLabelTextBlock.x - v.x))
            }
            return g
        }
    ...
    F.prototype.createLabels = function() {
        ...
        if (this.labelAutoFit || this._options.labelAutoFit)
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) {
                ...
                if (!this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock, l = a.measureText(), b < this._labels.length -
                            ...
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? g : Math.min((d -
                                ...
                                if (x(this._options.labelWrap))
                                    ...
                                    this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = u;
                                else if (0 === h)
                                    for (this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? d : this._options.labelFontSize, this.sessionVariables.labelWrap = !0, d = 0; d < this._labels.length; d++) a = this._labels[d].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, m), u), l = a.measureText(), d < this._labels.length - 1 && (q = d + 1, c = this._labels[q].textBlock, c.maxWidth = this.sessionVariables.labelMaxWidth =
                                        Math.min(Math.max(f, m), u), c = c.measureText(), l.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                            } else {
                        this.sessionVariables.labelAngle = this.labelAngle;
                        ...
                        var u = 0 != this.labelAngle ? (n - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : f;
                        this.sessionVariables.labelMaxHeight =
                            g = this.labelWrap ? (n - u * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize;
            ...
            this._position)
            if (f = x(this._options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth, !this.chart.panEnabled && 1 <= this._labels.length) {
                this.sessionVariables.labelFontSize = this.labelFontSize;
                this.sessionVariables.labelMaxWidth = f;
                this.sessionVariables.labelMaxHeight = g;
                this.sessionVariables.labelAngle = x(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle;
                this.sessionVariables.labelWrap = this.labelWrap;
                for (b = 0; b < this._labels.length; b++)(a = this._labels[b].textBlock, l = a.measureText(),
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === f.labelPlacement) {
                ...
                if ("left" === this._position ||
                    "right" === this._position) t = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                c = x(f._options.labelBackgroundColor) ? "#EEEEEE" : f._options.labelBackgroundColor
            } else g = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, t = "undefined" === typeof f._options.labelWrap || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >>
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                !1 === f.highlightEnabled || !0 !== d.highlightEnabled && !0 !== f.highlightEnabled ||
                    ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "scatter" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type ? (f = d.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), P.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = d.getMarkerProperties(g,
                        ...
                        d.type || "stackedBar100" === d.type || "rangeColumn" === d.type ? M(c, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? ya(c, e.center, e.radius, "transparent", d.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "candlestick" === d.type ? (c.globalAlpha = 1, c.strokeStyle = e.color, c.lineWidth = 2 * e.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(e.x3 - d, Math.min(e.y2, e.y3)), c.lineTo(e.x3 - d, Math.min(e.y1, e.y4)), c.stroke(), c.beginPath(), c.moveTo(e.x3 - d, Math.max(e.y1, e.y4)),
    ...
    Ia.Chart.version = "v1.8.5 Beta 2";
    window.CanvasJS = Ia
})();
/*
